    ...
    var $body = $(document.body),
        params = {
            ...
            success: function(line_item) {
                ...
                addClass(document.documentElement, 'offCanvasAddToBag');
...
var ajaxCart = (function(module, $) {
    ...
    itemAddedCallback = function (product) {
        setTimeout(function() {
            $addToCart.removeClass('is-adding').addClass('is-added').delay(10000).queue(function(rvt) {
    ...
    adjustCart = function () {
        ...
        $body.on('click', '.ajaxcart__remove a', function() {
            var $el = $(this),
                $qtySelector = $el.parent().parent().find('.ajaxcart__qty-num'),
                line = $el.parents('.ajaxcart__row').eq(0).data('line'),
                qty = 0;
            if (line) {
                updateQuantity(line, qty);
            } else {
        ...
        if (numInputs.length) {
            ...
            $('.js-qty__adjust').on('click', function() {
                ...
                if ($el.hasClass('js-qty__adjust--plus')) {
                    ...
                    qty -= 1;
                    if(!$el.parent().parent().hasClass('bag-edit')){
                        if (qty <= 1) qty = 1;
                    }
                }
